#!/usr/bin/env python3
"""
NovaWireless-GoodhartLab — Customer + Account Graph Generator
...
@dataclass
class LineGenConfig:
    usage_snapshot_date: str = "2025-12-31"
...
# --------------------------------------------------------------------------------------
def main() -> int:
    ap = argparse.ArgumentParser(description="NovaWireless-GoodhartLab — Customer Generator")
